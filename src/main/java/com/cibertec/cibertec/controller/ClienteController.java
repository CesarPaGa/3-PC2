...
public class ClienteController {
    ...
    public ResponseEntity<?> registrarCliente(@RequestBody Cliente cliente){
        ...
        try {
            Cliente objSalida = clienteService.saveCliente(cliente);
            salida.put("mesaje", "Cliente registrado con ID " + objSalida.getIdcliente());
        } catch (Exception e) {
    ...
    public ResponseEntity<?> ActualizarCliente(@RequestBody Cliente cliente){
        ...
        try {
            Cliente objSalida = clienteService.saveCliente(cliente);
            salida.put("mesaje", "Cliente actualizado con ID " + objSalida.getIdcliente());
        } catch (Exception e) {
    ...
    public ResponseEntity<?> eliminarCliente(@PathVariable("id") int id){
        ...
        try {
            ...
            salida.put("mesaje", "Cliente eliminado con ID " + id);
        } catch (Exception e) {
